  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4" style={{ backgroundColor: bgColor }}>
      ...
      >
        ...
        <button className="w-full font-semibold py-2 rounded-lg transition duration-200 border border-gray-200 hover:bg-gray-200 hover:text-white cursor-pointer mt-4 flex items-center justify-center gap-2">
          <FcGoogle size={20} />
